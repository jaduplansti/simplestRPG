...
class Skill:
  def __init__(self, name, desc, energy, rank, range = 0, level = 0, passive = False, passive_type = None):
    self.name = name;
    self.energy = energy;
    self.rank = rank
    self.level = level;
...
SKILLS = {
  "arrow rain" : {
    "skill" : Skill("arrow rain", "shoots a volley of arrows at the enemy, inflicting 5 stacks of bleeding.", 25, "C+", range = 6), 
    "action" : action_normal_damage
  },
  "bow bash" : {
    "skill" : Skill("bow bash", "smash the bow into a enemy, dealing mediocre damage", 15, "D", range = 2), 
    "action" : action_normal_damage
  },
  "trislash" : {
     "skill" : Skill("trislash", "triple the slash, triple the fun.", 30, "C+", range = 2), 
     "action" : action_normal_damage
  },
  "soul shatter" : {
     "skill" : Skill("soul shatter", "a divine technique capable of crushing the soul of the enemy, cannot be blocked or nullified", 80, "S+", range = 0), 
     "action" : action_normal_damage
  },
  "parry" : {
  ...
  "divine restriction" : {
    "skill" : Skill("divine restriction", "chains of a sinner, restricting for 5 stacks..", 30, "C+", range = 3), 
    "action" : action_normal_recover
  },
  "status wipe" : {
    "skill" : Skill("status wipe", "fear, clears status of the enemy including karma.", 10, "C+", range = 3), 
    "action" : action_normal_recover
  },
  "hyper precision" : {
    "skill" : Skill("hyper precision", "you see flaws in every stance, your attacks have a 50% to block break!", 0, "C+", range = 0, passive = True, passive_type = "attack"), 
    "action" : action_passive
  },
  "flowing blade" : {
    "skill" : Skill("flowing blade", "the ultimate defense, when you are both blocking and parrying, you apply 2 stacks of stun and reset your stance.", 0, "C+", range = 0, passive = True, passive_type = "attack"), 
    "action" : action_passive
  },
  "arrow return" : {
    "skill" : Skill("arrow return", "arrows shot have a 33% chance to return a arrow.", 0, "C-", range = 0, passive = True, passive_type = "attack"), 
    "action" : action_passive
  },
  "divine protection" : {
    "skill" : Skill("divine protection", "as a follower of god, you are blessed by thy protecion.", 0, "B-", range = 0, passive = True, passive_type = "death"), 
    "action" : action_passive
  },
}